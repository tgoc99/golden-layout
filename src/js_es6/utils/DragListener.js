...
export default class DragListener extends EventEmitter {
    constructor(eElement, nButtonCode, identity) {

        super();

        this._timeout = null
        this.bvIdentity = identity;
        console.log(this.bvIdentity);
    ...
    onMouseDown(oEvent) {
        ...
        // if (oEvent.button == 0 || oEvent.type === "touchstart") {
            ...
            if(this.bvIdentity) {
                ...
                const identityString = `${this.bvIdentity.uuid}/${this.bvIdentity.name}/${winIdentity.uuid}/${winIdentity.name}`;
                // const fin = fin || false;
                // if (fin) {
